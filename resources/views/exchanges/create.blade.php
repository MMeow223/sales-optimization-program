            ...
            <div class="row g-2 mb-2">
                ...
                <div class="col-6">
                    <div class="form-floating">
                        {{Form::select('other_device_brand',$deviceBrands,'',['class' => 'form-control'])}}
                ...
                <div class="col-6">
                    <div class="form-floating">
                        ...
                        {{Form::select('other_device_model',$deviceModels,'',['class' => 'form-control'])}}
            ...
            <div class="row g-2 mb-2">
                <div class="col-12 col-md-6">
                    <div class="form-floating">
                        ...
                        {{Form::select('our_device_model',$deviceModels ,'',['class' => 'form-control'])}}
