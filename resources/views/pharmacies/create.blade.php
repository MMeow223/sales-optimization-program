...
@section('content')
    {!! Form::open(['route' => 'pharmacies.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="row mb-2">
        ...
        <div class="d-flex justify-content-end">
            {{ Form::submit('ADD NEW PHARMACY', ['class' => 'btn btn-success mx-2']) }}
    ...
    <fieldset class="customFieldset p-2">
        ...
        <div class="row g-2 mb-2">
            <div class="col-6">
                <div class="form-floating">
                    {{ Form::text('pharmacy_address_1', '', ['class' => 'form-control', 'placeholder' => "Address Line 1*"])}}
                    {{ Form::label('pharmacy_address_1', "Address Line 1*")}}
                </div>
            </div>
            <div class="col-6">
                <div class="form-floating">
                    {{ Form::text('pharmacy_address_2', '', ['class' => 'form-control', 'placeholder' => "Address Line 2"])}}
        ...
        <div class="row g-2 mb-2">
            <div class="col-12">
                <div class="form-floating">
                    {{ Form::text('pharmacy_postcode', '', ['class' => 'form-control', 'placeholder' => "Zipcode*"])}}
        ...
        <div class="row g-2 mb-2">
            ...
            <div class="col-6">
                <div class="form-floating">
                    {{ Form::text('pharmacy_phone', '', ['class' => 'form-control', 'placeholder' => "PIC Contact*"])}}
